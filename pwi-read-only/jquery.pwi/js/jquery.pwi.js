...
(function ($) {
    ...
    $.fn.pwi.defaults = {
        ...
        photoSize: "1600", //-- size of large photo loaded in fancybox or other. Allowed sizes: auto, 94, 110, 128, 200, 220, 288, 320, 400, 512, 576, 640, 720, 800, 912, 1024, 1152, 1280, 1440, 1600
...
function formatPhotoTitleFancyBox() {
    ...
    this.title += '<br />';
    // add a textbox
    this.title += '<input type="foo" id="blah"/>';
    return;
